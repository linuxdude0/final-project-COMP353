<html><head><style>table, th, td {border:1px solid black;}</style><title>Team</title></head><body><?php
...
<form action='' method='POST'>
	...
	teamCoachID:<input name='teamCoachID'  type='number'  ><br>
	teamLocation:<input name='teamLocation'  type='number'  ><br>
