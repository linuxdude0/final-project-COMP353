<html><head><style>table, th, td {border:1px solid black;}</style><title>SecondaryFamilyMember</title></head><body><?php
...
$select_statement = 'SELECT * FROM SecondaryFamilyMember';
$insert_statement = $conn->prepare('INSERT INTO SecondaryFamilyMember(firstName,lastName,phone) VALUES (?,?,?)');
$insert_statement->bind_param('sss', $_POST['firstName'],$_POST['lastName'],$_POST['phone']);
...
if(isset($_POST['delete_form_submit'])) {
	...
	try{
		if(!$conn->query("DELETE FROM SecondaryFamilyMember WHERE ".$_POST['delete_select']." = ".$type."")) {
			die('huh????');
		}
		header('Refresh:0');
...
if(isset($_POST['update_form_submit'])) {
	...
	try{
	$conn->query("UPDATE SecondaryFamilyMember SET ".$_POST['update_select_new_val']." = ".$a." WHERE ".$_POST['update_select_condition']." = ".$b."");
	header('Refresh:0');
...
<form action='' method='POST'>
	firstName:<input name='firstName'  type='text' maxlength='256'  required><br>
	lastName:<input name='lastName'  type='text' maxlength='256'  ><br>
	phone:<input name='phone'  type='text' maxlength='256'  required><br>
...
<script>
	function select_input_delete(e) {
		switch(e.target.value) {
			...
			case 'firstName':
				document.getElementById('input_delete').innerHTML = 
					"<input name='delete_firstName'  type='text' maxlength='256'  required><br>";
			break;
			case 'lastName':
				document.getElementById('input_delete').innerHTML = 
					"<input name='delete_lastName'  type='text' maxlength='256'  required><br>";
			break;
			case 'phone':
				document.getElementById('input_delete').innerHTML = 
					"<input name='delete_phone'  type='text' maxlength='256'  required><br>";
			break;
		}
	}
	function select_input_update_new(e) {
		switch(e.target.value) {
			...
			case 'firstName':
				document.getElementById('input_update_new_val').innerHTML = 
					"<input name='update_new_val_firstName'  type='text' maxlength='256'  required><br>";
			break;
			case 'lastName':
				document.getElementById('input_update_new_val').innerHTML = 
					"<input name='update_new_val_lastName'  type='text' maxlength='256'  required><br>";
			break;
			case 'phone':
				document.getElementById('input_update_new_val').innerHTML = 
					"<input name='update_new_val_phone'  type='text' maxlength='256'  required><br>";
			break;
		}
	}
	function select_input_update_cond(e) {
		switch(e.target.value) {
			...
			case 'firstName':
				document.getElementById('input_update_condition').innerHTML = 
					"<input name='update_condition_firstName'  type='text' maxlength='256'  required><br>";
			break;
			case 'lastName':
				document.getElementById('input_update_condition').innerHTML = 
					"<input name='update_condition_lastName'  type='text' maxlength='256'  required><br>";
			break;
			case 'phone':
				document.getElementById('input_update_condition').innerHTML = 
					"<input name='update_condition_phone'  type='text' maxlength='256'  required><br>";
			break;
		}
	}
</script>
